...
st.write("Enter a short movie storyline/description and get the top 5 semantically similar movies.")

user_input = st.text_area("Enter storyline (or paste a short plot):", height=160)
